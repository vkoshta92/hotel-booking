...
class Cust_Win:
    def __init__(self,root):
        ...
        btnSearch=Button(table_Frame,text="Serach",command=self.search,font=("arial",12,"bold"),bg="black",fg="gold",width=9)
    ...
    # table me data fetch krne ke liye
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="Noida37@",database="management")
        my_cursor=conn.cursor()
    ...
    # table me select krne par table data select krne ke liye
