...
class HotelManagementSytem:
    def __init__(self,root):
        ...
        # ........................first image
        img1=Image.open(r"G:\coding\data\My Data\python\project\hotel booking\images\hotel1.png")
        # antilias high level image ko low level me krta hai.
        ...
        # details_btn-3
        details_btn=Button(btn_frame,text="DETAILS",width=22,font=("times new roman",14,"bold"),bd=0,bg="black",fg="gold",cursor="hand1")
        details_btn.grid(row=2,column=0,pady=1)
        
        
        # report_btn-4
        report_btn=Button(btn_frame,text="REPORT",width=22,font=("times new roman",14,"bold"),bd=0,bg="black",fg="gold",cursor="hand1")
        ...
        img3=Image.open(r"G:\coding\data\My Data\python\project\hotel booking\images\slide3.jpg")
        ...
        img4=Image.open(r"G:\coding\data\My Data\python\project\hotel booking\images\myh.jpg")
        ...
        img5=Image.open(r"G:\coding\data\My Data\python\project\hotel booking\images\khana.jpg")
